...
class PoseDesign(Node):
    def __init__(self):
        ...
        self.PublisherPose = self.create_publisher(
            JPOUT, '/effectors/joint_positions', 10)  # position publisher
    ...
    def applicationMake(self, send):
        ...
        image = Path(Path(Path.cwd(), 'src', 'pose_design',
                     'pose_design'), 'image.jpeg')  # image path
